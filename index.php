...
<html lang="en">
	...
	?>
		<div class="container">
			...
			<button type="button" class="btn btn-primary m-2 text-center" onclick="window.location='add-product.php';">ADD</button>
			<button type="submit" name="massDelete" id="delete-product-btn" class="btn btn-danger w-30 m-5 text-center">MASS DELETE</button>
